...
export type RoomConfig={gameMode:'battleRoyale'|'openArena';maxHumans:number;configuredAiCount:number;maxTotalCombatants:number;joinInProgress:boolean;zoneEnabled:boolean;respawnEnabled:boolean};
...
export class Network {
  ...
  private attach(){
    ...
    for(const type of ['chat','aiDialogue','killfeed','result','error','notice','pong','kicked','pickupResult','slotSwapResult','positionRecovery','vehicleRecovery','characterDeath','audioEvent'])this.room.onMessage(type,(p:any)=>{
