...
describe('shared rules', () => {
  ...
  it('contains fists and six firearms including sniper and bazooka', () => {
    expect(Object.keys(WEAPONS)).toEqual(['fists', 'pistol', 'smg', 'rifle', 'shotgun', 'sniper', 'bazooka']);
  });
  ...
  it('uses four pickup ammo types and keeps rockets separate', () => {
    expect(Object.keys(AMMO_DISPLAY_NAMES).sort()).toEqual(['pistol_ammo','rocket_ammo','shotgun_ammo','standard_ammo']);
