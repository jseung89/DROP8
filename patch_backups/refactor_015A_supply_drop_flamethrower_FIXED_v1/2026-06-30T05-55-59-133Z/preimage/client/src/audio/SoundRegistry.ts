...
const entries:SoundDefinition[]=[
  ...
  define('weapon_pistol_fire','weapon',.72,800,8,12,40),define('weapon_smg_fire','weapon',.57,900,8,12,28),define('weapon_rifle_fire','weapon',.72,1100,8,12,45),define('weapon_shotgun_fire','weapon',.96,1050,9,8,90),define('weapon_sniper_fire','weapon',1,1500,10,6,150),define('weapon_bazooka_fire','weapon',1,1500,10,4,220),
