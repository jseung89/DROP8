...
export type Snapshot={
  ...
  aliveCount:number;winner:string;players:any[];bullets:any[];rockets:any[];loot:any[];motorcycles:any[];explosions:any[];thrownObjects:any[];smokeFields:any[];fireFields:any[];receivedAt:number;
};
...
export class Network {
  ...
  async leave(consented=true){
    ...
    this.thrownObjectCache.clear();this.smokeFieldCache.clear();this.fireFieldCache.clear();
    this.patchIntervals=[];
    this.lastPatchAt=0;
