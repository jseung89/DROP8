...
const logisticsAnchors=[
  ...
  ...gridAnchors('dock8-loot-logistics-storage',5740,3700,460,360,2,2,'military','dock8-building-9',9006),
];
const adminAnchors=[...gridAnchors('dock8-loot-admin-main',4800,720,350,820,2,3,'hospital','dock8-building-10',9010),...gridAnchors('dock8-loot-admin-office',5480,720,300,330,2,2,'hospital','dock8-building-10',9012),...gridAnchors('dock8-loot-admin-lounge',5480,1230,300,300,2,2,'hospital','dock8-building-10',9013)];
const coldAnchors=[...gridAnchors('dock8-loot-cold-main',4770,5110,480,950,3,3,'residential','dock8-building-11',9020),...gridAnchors('dock8-loot-cold-a',5620,5090,340,390,2,2,'residential','dock8-building-11',9022),...gridAnchors('dock8-loot-cold-b',5620,5680,340,370,2,2,'residential','dock8-building-11',9023)];
const outdoorAnchors=[
  ...
  ...gridAnchors('dock8-loot-river-west',2600,260,350,6500,2,6,'forestCamp'),
  ...gridAnchors('dock8-loot-river-east',4050,260,350,6500,2,6,'forestCamp'),
];

export const DOCK8_LOOT_ANCHORS:LootAnchor[]=[...logisticsAnchors,...adminAnchors,...coldAnchors,...outdoorAnchors].slice(0,172);

export const DOCK8_MOTORCYCLE_SPAWNS=[
  {id:'bike-dock8-1',x:1080,y:4580,rotation:0},
  {id:'bike-dock8-2',x:2250,y:5940,rotation:-Math.PI/2},
  {id:'bike-dock8-3',x:4460,y:4470,rotation:Math.PI},
  {id:'bike-dock8-4',x:6410,y:5530,rotation:Math.PI/2},
];
