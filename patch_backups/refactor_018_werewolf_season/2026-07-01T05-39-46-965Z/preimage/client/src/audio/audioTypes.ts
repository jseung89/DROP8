...
export type SoundId =
  ...
  | 'weapon_pistol_fire' | 'weapon_smg_fire' | 'weapon_rifle_fire' | 'weapon_shotgun_fire' | 'weapon_sniper_fire' | 'weapon_bazooka_fire' | 'weapon_flamethrower_fire' | 'weapon_adhesive_sprayer_fire'
