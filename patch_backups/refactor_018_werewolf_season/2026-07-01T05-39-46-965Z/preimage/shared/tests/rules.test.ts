...
describe('shared rules', () => {
  ...
  it('contains fists and eight equippable weapons including the adhesive sprayer', () => {
    expect(Object.keys(WEAPONS)).toEqual(['fists', 'pistol', 'smg', 'rifle', 'shotgun', 'sniper', 'bazooka', 'flamethrower', 'adhesive_sprayer']);
  });
  ...
  it('uses six pickup ammo types and keeps rockets and adhesive charge separate', () => {
    expect(Object.keys(AMMO_DISPLAY_NAMES).sort()).toEqual(['adhesive_charge','fuel_ammo','pistol_ammo','rocket_ammo','shotgun_ammo','standard_ammo']);
